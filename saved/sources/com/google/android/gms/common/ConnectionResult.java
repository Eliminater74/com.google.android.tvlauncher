...
public final class ConnectionResult extends zzbkv {
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != connectionResult.zzc || !zzak.zza(this.zzd, connectionResult.zzd) || !zzak.zza(this.zze, connectionResult.zze)) {
            return false;
        }
        return true;
    }
    ...
    public final void writeToParcel(Parcel parcel, int i) {
        ...
        zzbky.zza(parcel, 2, getErrorCode());
        zzbky.zza(parcel, 3, (Parcelable) getResolution(), i, false);
        zzbky.zza(parcel, 4, getErrorMessage(), false);
