...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public static class OutOfSpaceException extends IOException {
        ...
        OutOfSpaceException(java.lang.String r4) {
            /*
                r3 = this;
        ...
        public final void writeUInt32NoTag(int value) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || Android.isOnAndroidDevice() || spaceLeft() < 5) {
                while ((value & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    bArr[i] = (byte) ((value & ClientAnalytics.LogRequest.LogSource.TAILORMADE_VALUE) | 128);
                    value >>>= 7;
                }
                try {
        ...
        public final void writeUInt64NoTag(long value) throws IOException {
            if (!CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS || spaceLeft() < 10) {
                while ((value & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    bArr[i] = (byte) ((((int) value) & ClientAnalytics.LogRequest.LogSource.TAILORMADE_VALUE) | 128);
                    value >>>= 7;
                }
                try {
                    byte[] bArr2 = this.buffer;
                ...
                while ((value & -128) != 0) {
                    ...
                    int i3 = this.position;
                    this.position = i3 + 1;
                    UnsafeUtil.putByte(bArr3, (long) i3, (byte) ((((int) value) & ClientAnalytics.LogRequest.LogSource.TAILORMADE_VALUE) | 128));
                    value >>>= 7;
                }
                byte[] bArr4 = this.buffer;
                int i4 = this.position;
    ...
    private static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            while ((value & -128) != 0) {
                this.buffer.put((byte) ((value & ClientAnalytics.LogRequest.LogSource.TAILORMADE_VALUE) | 128));
                value >>>= 7;
            }
            try {
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            while ((-128 & value) != 0) {
                this.buffer.put((byte) ((((int) value) & ClientAnalytics.LogRequest.LogSource.TAILORMADE_VALUE) | 128));
                value >>>= 7;
            }
            try {
        ...
        public void writeUInt32NoTag(int value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((value & -128) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((value & ClientAnalytics.LogRequest.LogSource.TAILORMADE_VALUE) | 128));
                    value >>>= 7;
                }
        ...
        public void writeUInt64NoTag(long value) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((value & -128) != 0) {
                    long j = this.position;
                    this.position = j + 1;
                    UnsafeUtil.putByte(j, (byte) ((((int) value) & ClientAnalytics.LogRequest.LogSource.TAILORMADE_VALUE) | 128));
                    value >>>= 7;
                }
                long j2 = this.position;
                this.position = 1 + j2;
            ...
            while (true) {
                ...
                if (j3 >= this.limit) {
                    ...
                    this.position = j3 + 1;
                    UnsafeUtil.putByte(j3, (byte) ((((int) value) & ClientAnalytics.LogRequest.LogSource.TAILORMADE_VALUE) | 128));
                    value >>>= 7;
                }
            }
        }
        ...
        public final void bufferUInt32NoTag(int value) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((value & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, (long) i, (byte) ((value & ClientAnalytics.LogRequest.LogSource.TAILORMADE_VALUE) | 128));
                    value >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
            ...
            while ((value & -128) != 0) {
                ...
                int i3 = this.position;
                this.position = i3 + 1;
                bArr3[i3] = (byte) ((value & ClientAnalytics.LogRequest.LogSource.TAILORMADE_VALUE) | 128);
                this.totalBytesWritten++;
                value >>>= 7;
            }
            byte[] bArr4 = this.buffer;
        ...
        public final void bufferUInt64NoTag(long value) {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS) {
                ...
                while ((value & -128) != 0) {
                    ...
                    int i = this.position;
                    this.position = i + 1;
                    UnsafeUtil.putByte(bArr, (long) i, (byte) ((((int) value) & ClientAnalytics.LogRequest.LogSource.TAILORMADE_VALUE) | 128));
                    value >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i2 = this.position;
            ...
            while ((value & -128) != 0) {
                ...
                int i3 = this.position;
                this.position = i3 + 1;
                bArr3[i3] = (byte) ((((int) value) & ClientAnalytics.LogRequest.LogSource.TAILORMADE_VALUE) | 128);
                this.totalBytesWritten++;
                value >>>= 7;
            }
            byte[] bArr4 = this.buffer;
