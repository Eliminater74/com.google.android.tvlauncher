...
public class Rotate extends BitmapTransformation {
    ...
    /* renamed from: ID */
    private static final String f62ID = "com.bumptech.glide.load.resource.bitmap.Rotate";
    ...
    public int hashCode() {
        return Util.hashCode(f62ID.hashCode(), Util.hashCode(this.degreesToRotate));
    }
