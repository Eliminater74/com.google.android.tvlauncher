...
public class SlidingPaneLayout extends ViewGroup {
    ...
    /* JADX INFO: Multiple debug info for r1v3 int: [D('measuredWidth' int), D('fixedPanelWidthLimit' int)] */
    /* JADX INFO: Multiple debug info for r8v5 int: [D('childWidthSpec' int), D('maxLayoutHeight' int)] */
    /* JADX INFO: Multiple debug info for r14v18 int: [D('skippedFirstPass' boolean), D('childWidthSpec' int)] */
    /* JADX INFO: Multiple debug info for r4v13 int: [D('childWidthSpec' int), D('childHeight' int)] */
    /* access modifiers changed from: protected */
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (widthMode != 1073741824) {
            ...
            if (!isInEditMode()) {
                ...
                heightSize2 = ClientAnalytics.LogRequest.LogSource.CHIME_VALUE;
            }
        }
        int layoutHeight = 0;
