...
public final class ShareCompat {
    ...
    public static String getCallingPackage(Activity calledActivity) {
        ...
        String result2 = calledActivity.getIntent().getStringExtra("android.support.v4.app.EXTRA_CALLING_PACKAGE");
        if (result2 == null) {
    ...
    public static ComponentName getCallingActivity(Activity calledActivity) {
        ...
        ComponentName result2 = (ComponentName) calledActivity.getIntent().getParcelableExtra("android.support.v4.app.EXTRA_CALLING_ACTIVITY");
        if (result2 == null) {
