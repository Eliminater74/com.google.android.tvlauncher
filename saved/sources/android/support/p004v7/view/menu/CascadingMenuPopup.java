...
final class CascadingMenuPopup extends MenuPopup implements MenuPresenter, View.OnKeyListener, PopupWindow.OnDismissListener {
    ...
    public CascadingMenuPopup(@NonNull Context context, @NonNull View anchor, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes, boolean overflowOnly) {
        ...
        this.mMenuMaxWidth = Math.max(res.getDisplayMetrics().widthPixels / 2, res.getDimensionPixelSize(C0233R.dimen.abc_config_prefDialogWidth));
    ...
    private void showMenu(@NonNull MenuBuilder menu) {
        ...
        if (parentInfo == null && this.mShowTitle && menu.getHeaderTitle() != null) {
            FrameLayout titleItemView = (FrameLayout) inflater.inflate(C0233R.layout.abc_popup_menu_header_item_layout, (ViewGroup) listView, false);
    ...
    private android.view.View findParentViewForSubmenu(@android.support.annotation.NonNull android.support.p004v7.view.menu.CascadingMenuPopup.CascadingMenuInfo r11, @android.support.annotation.NonNull android.support.p004v7.view.menu.MenuBuilder r12) {
        /*
            r10 = this;
