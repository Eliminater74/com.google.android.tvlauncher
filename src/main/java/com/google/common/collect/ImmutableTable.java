...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public ImmutableMap<R, V> column(C columnKey) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) columnMap().get(columnKey), ImmutableMap.m126of());
    }
    ...
    public ImmutableMap<C, V> row(R rowKey) {
        ...
        return (ImmutableMap) MoreObjects.firstNonNull((ImmutableMap) rowMap().get(rowKey), ImmutableMap.m126of());
    }
