...
public class RegistrationInfo extends zzbkv {
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        zzbky.zza(parcel, 1, this.configPackage, false);
        zzbky.zza(parcel, 2, this.version);
        zzbky.zza(parcel, 3, this.logSourceNames, false);
        zzbky.zza(parcel, 4, this.params, false);
        zzbky.zza(parcel, 5, this.weak);
        zzbky.zza(parcel, 6, this.weakExperimentIds, false);
        zzbky.zza(parcel, 7, this.androidPackage, false);
