...
/* compiled from: Utf8 */
final class zzgrl {
    private static final zzgrm zza = (zzgrj.zza() && zzgrj.zzb() ? new zzgrp() : new zzgrn());
    ...
    static void zza(CharSequence charSequence, ByteBuffer byteBuffer) {
        ...
        if (byteBuffer.hasArray()) {
            ...
            zzgrm.zza(charSequence, byteBuffer);
        } else {
            zzgrm.zzb(charSequence, byteBuffer);
        }
    }
}
