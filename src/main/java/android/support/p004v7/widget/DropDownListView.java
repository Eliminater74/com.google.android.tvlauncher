...
class DropDownListView extends ListView {
    ...
    /* JADX INFO: Multiple debug info for r2v2 int: [D('newType' int), D('paddingTop' int)] */
    /* JADX INFO: Multiple debug info for r19v1 int: [D('paddingBottom' int), D('childLp' android.view.ViewGroup$LayoutParams)] */
