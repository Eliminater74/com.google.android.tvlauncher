...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void updateTextPositions(int position, float positionOffset, boolean force) {
        ...
        textView.layout(currLeft, prevTop, halfCurrWidth2, prevTop + textView.getMeasuredHeight());
        int prevLeft = Math.min(paddingLeft, (currLeft - this.mScaledTextSpacing) - prevWidth);
        TextView textView2 = this.mPrevText;
        textView2.layout(prevLeft, vgrav, prevLeft + prevWidth, vgrav + textView2.getMeasuredHeight());
        ...
        textView3.layout(nextLeft, stripHeight, nextLeft + nextWidth, stripHeight + textView3.getMeasuredHeight());
