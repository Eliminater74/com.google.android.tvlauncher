...
public class GuidedStepFragment extends Fragment implements GuidedActionAdapter.FocusListener {
    ...
    public void onProvideFragmentTransitions() {
        if (Build.VERSION.SDK_INT >= 21) {
            ...
            if (uiStyle == 0) {
                ...
                setSharedElementEnterTransition((Transition) sharedElementTransition);
            } else if (uiStyle == 1) {
                if (this.entranceTransitionType == 0) {
                    ...
                    setEnterTransition((Transition) enterTransition2);
                } else {
                    ...
                    setEnterTransition((Transition) enterTransition3);
                }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        C04462 r2 = new GuidedActionAdapter.ClickListener() {
            public void onGuidedActionClicked(GuidedAction action) {
        ...
        if (this.mButtonActions.size() == 0) {
            ...
            if (ctx == null) {
                ctx = FragmentUtil.getContext(this);
            }
