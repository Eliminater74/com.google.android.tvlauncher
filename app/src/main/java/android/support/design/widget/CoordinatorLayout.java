...
import android.support.coordinatorlayout.C0017R;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
    ...
    /* JADX INFO: Multiple debug info for r2v3 int: [D('childState' int), D('heightUsed' int)] */
    /* JADX INFO: Multiple debug info for r1v4 int: [D('widthUsed' int), D('heightUsed' int)] */
    /* JADX INFO: Multiple debug info for r3v3 int: [D('childState' int), D('widthUsed' int)] */
    /* access modifiers changed from: protected */
    /* JADX WARNING: Code restructure failed: missing block: B:42:0x013c, code lost:
        if (r29.onMeasureChild(r1, r21, r26, r23, r28, 0) == false) goto L_0x014d;
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
