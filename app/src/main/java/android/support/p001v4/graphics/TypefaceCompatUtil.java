...
public class TypefaceCompatUtil {
    ...
    public static java.nio.ByteBuffer mmap(android.content.Context r10, android.os.CancellationSignal r11, android.net.Uri r12) {
        /*
            ...
            android.os.ParcelFileDescriptor r2 = r0.openFileDescriptor(r12, r2, r11)     // Catch:{ IOException -> 0x004d }
        ...
        L_0x0014:
            return r1
        L_0x0015:
            java.io.FileInputStream r3 = new java.io.FileInputStream     // Catch:{ all -> 0x0041 }
            java.io.FileDescriptor r4 = r2.getFileDescriptor()     // Catch:{ all -> 0x0041 }
        ...
        L_0x003c:
            r6 = move-exception
            com.google.devtools.build.android.desugar.runtime.ThrowableExtension.addSuppressed(r4, r6)     // Catch:{ all -> 0x0041 }
        L_0x0040:
        ...
        L_0x0048:
            r5 = move-exception
            com.google.devtools.build.android.desugar.runtime.ThrowableExtension.addSuppressed(r3, r5)     // Catch:{ IOException -> 0x004d }
        L_0x004c:
