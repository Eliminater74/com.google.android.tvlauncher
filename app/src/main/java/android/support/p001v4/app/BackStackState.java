...
final class BackStackState implements Parcelable {
    ...
    public BackStackState(BackStackRecord bse) {
        ...
        if (bse.mAddToBackStack) {
            ...
            this.mLifecycleStates = new ArrayList<>(numOps);
            int pos = 0;
            int opNum = 0;
            while (opNum < numOps) {
                FragmentTransaction.C0075Op op = (FragmentTransaction.C0075Op) bse.mOps.get(opNum);
                int pos2 = pos + 1;
                ...
                this.mLifecycleStates.add(op.mState.name());
                opNum++;
                pos = pos5 + 1;
            }
    ...
    public BackStackState(Parcel in) {
        ...
        this.mLifecycleStates = in.createStringArrayList();
    ...
    public BackStackRecord instantiate(FragmentManagerImpl fm) {
        ...
        while (pos < this.mOps.length) {
            FragmentTransaction.C0075Op op = new FragmentTransaction.C0075Op();
            int pos2 = pos + 1;
            ...
            op.mState = Lifecycle.State.valueOf(this.mLifecycleStates.get(num));
            int[] iArr = this.mOps;
            int pos3 = pos2 + 1;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeStringList(this.mLifecycleStates);
