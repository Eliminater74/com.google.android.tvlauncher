...
public class ViewPager extends ViewGroup {
    ...
    public android.support.p001v4.view.ViewPager.ItemInfo infoForAnyChild(android.view.View r3) {
        /*
            r2 = this;
        L_0x0000:
        ...
        L_0x000d:
            ...
            goto L_0x0000
        L_0x0011:
            android.support.v4.view.ViewPager$ItemInfo r0 = r2.infoForChild(r3)
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p001v4.view.ViewPager.infoForAnyChild(android.view.View):android.support.v4.view.ViewPager$ItemInfo");
    }
    ...
    /* JADX INFO: Multiple debug info for r2v5 int: [D('widthSize' int), D('heightSpec' int)] */
    /* access modifiers changed from: protected */
    public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int makeMeasureSpec = View.MeasureSpec.makeMeasureSpec(childWidthSize, 1073741824);
        int childHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(childHeightSize, 1073741824);
        this.mInLayout = true;
        populate();
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            if (child2.getVisibility() != 8 && ((lp = (LayoutParams) child2.getLayoutParams()) == null || !lp.isDecor)) {
                child2.measure(View.MeasureSpec.makeMeasureSpec((int) (((float) childWidthSize) * lp.widthFactor), 1073741824), childHeightMeasureSpec);
            }
        }
    }
            ...
            if (child2.getVisibility() != i) {
                ...
                if (!lp2.isDecor) {
                    ...
                    if (infoForChild != null) {
                        ItemInfo ii2 = ii;
                        count = count2;
                        int childLeft3 = paddingLeft2 + ((int) (((float) childWidth) * ii2.offset));
    ...
    public void setDragInGutterEnabled(boolean enabled) {
        this.mDragInGutterEnabled = enabled;
    }
    ...
    /* JADX INFO: Multiple debug info for r2v11 int: [D('action' int), D('nextPage' int)] */
