...
public class ViewCompat {
    ...
    public static void setPaddingRelative(@NonNull View view, @C0013Px int start, @C0013Px int top, @C0013Px int end, @C0013Px int bottom) {
        if (Build.VERSION.SDK_INT >= 17) {
    ...
    @Deprecated
    public static void setAlpha(View view, @FloatRange(from = 0.0d, mo106to = 1.0d) float value) {
        view.setAlpha(value);
    }
    ...
    public static void addOnUnhandledKeyEventListener(@NonNull View v, @NonNull final OnUnhandledKeyEventListenerCompat listener) {
        if (Build.VERSION.SDK_INT >= 28) {
            Map<OnUnhandledKeyEventListenerCompat, View.OnUnhandledKeyEventListener> viewListeners = (Map) v.getTag(C0014R.C0016id.tag_unhandled_key_listeners);
