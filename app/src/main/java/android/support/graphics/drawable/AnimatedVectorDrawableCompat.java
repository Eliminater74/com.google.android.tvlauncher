...
public class AnimatedVectorDrawableCompat extends VectorDrawableCommon implements Animatable2Compat {
    ...
    public static android.support.graphics.drawable.AnimatedVectorDrawableCompat create(@android.support.annotation.NonNull android.content.Context r8, @android.support.annotation.DrawableRes int r9) {
        /*
            ...
            android.graphics.drawable.Drawable r1 = android.support.p001v4.content.res.ResourcesCompat.getDrawable(r1, r9, r2)
        ...
        L_0x004b:
            ...
            android.support.graphics.drawable.AnimatedVectorDrawableCompat r0 = createFromXmlInner(r8, r5, r3, r4, r7)     // Catch:{ XmlPullParserException -> 0x0067, IOException -> 0x0062 }
            return r0
        L_0x005a:
