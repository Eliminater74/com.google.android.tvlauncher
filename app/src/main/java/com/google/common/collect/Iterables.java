...
public final class Iterables {
    ...
    /* JADX INFO: Multiple debug info for r0v1 java.util.Iterator<? extends T>: [D('list' java.util.List<? extends T>), D('iterator' java.util.Iterator<? extends T>)] */
    @NullableDecl
    ...
    public static <T> Iterable<T> skip(final Iterable<T> iterable, final int numberToSkip) {
        ...
        return new FluentIterable<T>() {
            /* JADX INFO: Multiple debug info for r0v1 java.util.Iterator: [D('iterator' java.util.Iterator<T>), D('list' java.util.List<T>)] */
            public Iterator<T> iterator() {
