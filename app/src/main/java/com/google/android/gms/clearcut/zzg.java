...
final class zzg extends zzdl<zzi, Long> {
    zzg(ClearcutLoggerDebugClient clearcutLoggerDebugClient) {
    }

    /* access modifiers changed from: protected */
    public final /* synthetic */ void zza(Api.zzb zzb, TaskCompletionSource taskCompletionSource) throws RemoteException {
        ((zzq) ((zzi) zzb).zzag()).zzb(new ClearcutLoggerDebugClient.zza(taskCompletionSource, null));
    }
}
