...
final class zzq extends zzdl<zzeac, DogfoodsToken> {
    zzq(PhenotypeClient phenotypeClient) {
    }

    /* access modifiers changed from: protected */
    public final /* synthetic */ void zza(Api.zzb zzb, TaskCompletionSource taskCompletionSource) throws RemoteException {
        ((zzdyr) ((zzeac) zzb).zzag()).zza(new PhenotypeClient.zza(taskCompletionSource, null));
    }
}
