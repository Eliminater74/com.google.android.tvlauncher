...
public class FlagOverride extends zzbkv {
    ...
    public FlagOverride(String str, String str2, Flag flag2, boolean z) {
    ...
    public boolean equals(Object obj) {
        ...
        if (!PhenotypeCore.zza(this.configurationName, flagOverride.configurationName) || !PhenotypeCore.zza(this.userName, flagOverride.userName) || !PhenotypeCore.zza(this.flag, flagOverride.flag) || this.committed != flagOverride.committed) {
            return false;
        }
        return true;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        zzbky.zza(parcel, 2, this.configurationName, false);
        zzbky.zza(parcel, 3, this.userName, false);
        zzbky.zza(parcel, 4, (Parcelable) this.flag, i, false);
        zzbky.zza(parcel, 5, this.committed);
