...
public class TalkContract {
    ...
    public interface ProviderNames {
        ...
        /* renamed from: QQ */
        public static final String f109QQ = "QQ";
    ...
    public static final class ContactsEtag implements BaseColumns, ContactsEtagColumns {
        ...
        public static final String getRosterEtag(ContentResolver resolver, long accountId) {
            String retVal = null;
            Uri uri = CONTENT_URI;
            String[] strArr = CONTACT_ETAG_PROJECTION;
            Cursor c = resolver.query(uri, strArr, "account=" + accountId, null, null);
            try {
                if (c.moveToFirst()) {
        ...
        public static final String getOtrEtag(ContentResolver resolver, long accountId) {
            String retVal = null;
            Uri uri = CONTENT_URI;
            String[] strArr = CONTACT_OTR_ETAG_PROJECTION;
            Cursor c = resolver.query(uri, strArr, "account=" + accountId, null, null);
            try {
                if (c.moveToFirst()) {
    ...
    public static class AccountSettings implements AccountSettingsColumns {
        ...
        public static void putLongValue(ContentResolver cr, String name, long value, long accountId) {
            ...
            v.put("account_id", Long.valueOf(accountId));
        ...
        public static boolean isEnabled(long value) {
            return (3 & value) == 1;
        }
        ...
        private static int getUserSettingValue(boolean enabled, boolean userSet) {
            return (enabled ? 1 : 2) | (userSet ? 16 : 0);
        }
        ...
        public static void setJidResource(ContentResolver contentResolver, String jidResource, long accountId) {
            putStringValue(contentResolver, "jid_resource", jidResource, accountId);
        }
        ...
        public static class QueryMap extends ContentQueryMap {
            ...
            public QueryMap(ContentResolver contentResolver, boolean keepUpdated, long accountId, Handler handlerForUpdateNotifications) {
                super(contentResolver.query(AccountSettings.getContentUriByAccountId(accountId), new String[]{"name", "value"}, null, null, null), "name", keepUpdated, handlerForUpdateNotifications);
            ...
            private boolean getBoolean(String name, boolean def) {
                ...
                return values != null ? values.getAsBoolean("value").booleanValue() : def;
            }
            ...
            private int getInteger(String name, int def) {
                ContentValues values = getValues(name);
                return values != null ? values.getAsInteger("value").intValue() : def;
            }

            private long getLong(String name, long def) {
                ContentValues values = getValues(name);
                return values != null ? values.getAsLong("value").longValue() : def;
            }
        }
    }
