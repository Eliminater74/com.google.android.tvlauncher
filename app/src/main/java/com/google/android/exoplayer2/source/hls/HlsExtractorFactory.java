...
public interface HlsExtractorFactory {
    ...
    public static final class Result {
        ...
        public Result(Extractor extractor2, boolean isPackedAudioExtractor2, boolean isReusable2) {
            this.extractor = extractor2;
            this.isPackedAudioExtractor = isPackedAudioExtractor2;
            this.isReusable = isReusable2;
        }
    }
}
