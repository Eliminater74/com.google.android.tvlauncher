...
public interface AnalyticsListener {
    ...
    public static final class EventTime {
        ...
        public EventTime(long realtimeMs2, Timeline timeline2, int windowIndex2, @Nullable MediaSource.MediaPeriodId mediaPeriodId2, long eventPlaybackPositionMs2, long currentPlaybackPositionMs2, long totalBufferedDurationMs2) {
