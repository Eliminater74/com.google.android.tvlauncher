...
public abstract class BaseRequestOptions<T extends BaseRequestOptions<T>> implements Cloneable {
    ...
    @CheckResult
    @NonNull
    public T sizeMultiplier(@FloatRange(from = 0.0d, mo106to = 1.0d) float sizeMultiplier2) {
    ...
    @CheckResult
    @NonNull
    public T encodeQuality(@IntRange(from = 0, mo124to = 100) int quality) {
    ...
    @NonNull
    private T scaleOnlyTransform(@NonNull DownsampleStrategy strategy, @NonNull Transformation<Bitmap> transformation, boolean isTransformationRequired2) {
    ...
    /* access modifiers changed from: package-private */
    @NonNull
    public T transform(@NonNull Transformation<Bitmap> transformation, boolean isRequired) {
        if (this.isAutoCloneEnabled) {
