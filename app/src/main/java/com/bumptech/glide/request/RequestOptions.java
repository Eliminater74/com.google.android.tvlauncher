...
public class RequestOptions extends BaseRequestOptions<RequestOptions> {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions sizeMultiplierOf(@FloatRange(from = 0.0d, mo106to = 1.0d) float sizeMultiplier) {
    ...
    @CheckResult
    @NonNull
    public static RequestOptions encodeQualityOf(@IntRange(from = 0, mo124to = 100) int quality) {
