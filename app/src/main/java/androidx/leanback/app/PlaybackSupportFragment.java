...
public class PlaybackSupportFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getContext().getTheme().resolveAttribute(C0364R.attr.playbackControlsAutoHideTimeout, outValue, true);
        this.mAutohideTimerAfterPlayingInMs = outValue.data;
        getContext().getTheme().resolveAttribute(C0364R.attr.playbackControlsAutoHideTickleTimeout, outValue, true);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        this.mRowsSupportFragment = (RowsSupportFragment) getChildFragmentManager().findFragmentById(C0364R.C0366id.playback_controls_dock);
        if (this.mRowsSupportFragment == null) {
            this.mRowsSupportFragment = new RowsSupportFragment();
            getChildFragmentManager().beginTransaction().replace(C0364R.C0366id.playback_controls_dock, this.mRowsSupportFragment).commit();
        }
